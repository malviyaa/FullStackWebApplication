				...
				<div class="width">
					...
					<br/>
						 ...
						 <div align="center" style = "border-radius: 5px; background-color:#666;width: 400px;padding: 10px; margin-right:auto; margin-left:auto;">
							...
							<form id="myForm" action="/EasyTrip/AddVehicleAdminServlet" method="post">
							...
							<p><label style ="color: #fff; font-weight: bold;" for="fname">ID (EasyTrip Designated Vehicle ID): </label> <input type="TEXT" size="15" id = "vehicleId" name="vehicleId"></input></p>
							<font color="red"><p id="vehicleIdMessage"></p></font>
							...
							<p><label style ="color: #fff; font-weight: bold;" for="fname">Vehicle Type: </label> <input type="text" size="15" id = "vehicleType" name="vehicleType"></input></p>
