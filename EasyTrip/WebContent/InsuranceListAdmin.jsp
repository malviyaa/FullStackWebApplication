			...
			<div >
				...
				<div class="width">
					...
					for(String key :displayInsurance.keySet()){
						...
						<tr>
							<td><label><b> <input type='hidden' name='insuranceId' value=<%=displayInsurance.get(key).getInsurancePolicyNumber()%> />INS<%=displayInsurance.get(key).getInsurancePolicyNumber() %></b></label></td>
