			...
			<div >
				...
				<div class="width">
					...
					if(request.getParameter("action").contentEquals("Delete"))
					{
						...
						<p><label style ="color: #FFFFFF; font-weight: bold;" for="fname">Accessory ID </label> <input type="TEXT" size="15" id="fName" name="accId" value="<%=request.getParameter("accId")%>" readonly></p>
				...
				<%	}
					...
					{
					%>
							<form id="myForm" action="/EasyTrip/UpdateAccessoryAdminServlet" method="post">
							
							<p><label style ="color: #FFFFFF; font-weight: bold;" for="fname">Accessory ID </label> <input type="TEXT" size="15" id="accId" name="accId" value="<%=request.getParameter("accId")%>" readonly></p>
							
							<p><label style ="color: #fff; font-weight: bold;" for="fname">Accessory name: </label> <input type="TEXT" size="15" id="accessoryName"  name="accessoryName" value="<%=request.getParameter("accessoryName")%>"></input></p>
							<font color="red"><p id="accessoryNameMessage"></p></font>
							<p><label style ="color: #fff; font-weight: bold;" for="fname">Total Stock: </label> <input type="TEXT" size="15" id="accessoryStock"  name="accessoryStock" value="<%=request.getParameter("accessoryStock")%>"></input></p>
							<font color="red"><p id="accessoryStockMessage"></p></font>
							<p><label style ="color: #fff; font-weight: bold;" for="fname">Available Stock: </label> <input type="text" size="15" id="accessoryAvailStock" name="accessoryAvailStock" value="<%=request.getParameter("accessoryAvailStock")%>"></input></p>
					    	<font color="red"><p id="accessoryAvailStockMessage"></p></font>	
							<p><label style ="color: #fff; font-weight: bold;" for="fname">Accessory Price Id: </label> <input type="TEXT" size="15" id="accessoryPrice" name="accessoryPrice" value="<%=request.getParameter("accessoryPrice")%>"></input></p>
