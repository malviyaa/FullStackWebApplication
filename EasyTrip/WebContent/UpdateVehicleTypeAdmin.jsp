	...
	<body>
			...
			<%	}
					else
					{
						 ...
						 %>
							<form  id="myForm" action="/EasyTrip/UpdateVehicleTypeAdminServlet" method="post">
							
							<p><label style ="color: #fff; font-weight: bold;" for="fname">Make: </label> <input type="TEXT" size="15" id="vehicleMake" name="vehicleMake" value="<%=request.getParameter("vehicleMake")%>" readonly></input></p>
							<font color="red"><p id="vehicleMakeMessage"></p></font>
							<p><label style ="color: #fff; font-weight: bold;" for="fname">Model: </label> <input type="text" size="15" id="vehicleModel" name="vehicleModel" value="<%=request.getParameter("vehicleModel")%>" readonly></input></p>
							...
							<p><label style ="color: #fff; font-weight: bold;" for="fname">Image Path: </label> <input type="TEXT" size="15" name="vehicleImage"></input></p>
