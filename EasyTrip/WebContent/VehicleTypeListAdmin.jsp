				...
				<div class="width">
					...
					<table>
						<tr>
							...
							<th style ="color: #fff; background-color:#2F2F2F">Capacity</th>
							<th style ="color: #fff; background-color:#2F2F2F">SLuggage</th>
							<th style ="color: #fff; background-color:#2F2F2F">LLuggage</th>
					...
					for(String key :displayVehicleInfo.keySet()){
						...
						<tr>
							...
							<td><label> <input type='hidden' name='vehicleMake' value=<%=displayVehicleInfo.get(key).getVehicleMake() %>><%=displayVehicleInfo.get(key).getVehicleMake() %></label></td>
							<td><label> <input type='hidden' name='vehicleModel' value=<%=displayVehicleInfo.get(key).getVehicleModel() %>><%=displayVehicleInfo.get(key).getVehicleModel() %></label></td>
