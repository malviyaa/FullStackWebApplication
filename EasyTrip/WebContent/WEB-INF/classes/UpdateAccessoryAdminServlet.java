...
public class UpdateAccessoryAdminServlet extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		Accessory updateAccessoryAdminObject = new Accessory(accId, accessoryName, accessoryStock, accessoryAvailStock,
				accessoryPrice);

		MySQLDataStoreUtilities.enterAccessory(updateAccessoryAdminObject);
		//
