...
import com.cs442.amalviy1.freefood_at_iit.asynctask.Database_Coments_entry;
...
public class AttractionListFragment extends Fragment {
   ...
   // private LatLng mLatestLocation;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        crTime = (TextView) view.findViewById(R.id.time) ;
        ...
        CountDownTimer newtimer = new CountDownTimer(1000000000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                crTime.setText(c.get(Calendar.MONTH)+"/"+c.get(Calendar.DATE)+"/"+c.get(Calendar.YEAR)+" "+c.get(Calendar.HOUR_OF_DAY)+":"+c.get(Calendar.MINUTE)+":"+c.get(Calendar.SECOND));
            }
...
//        swipeContainer.setRefreshing(true);
    ...
    private class AttractionAdapter extends RecyclerView.Adapter<ViewHolder>
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            holder.mlocation.setText(attraction.getLocation());
            holder.mComments.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Log.d("in fragment   "+attraction.getId(),"");

                    IdstorePojo idstorePojo= new IdstorePojo(attraction.getId());





                    Intent myIntent = new Intent(getActivity(), CommentPop.class);
                    startActivity(myIntent);
                    Log.d( "OnBind", "View Holder" );
                }});
    ...
    private static class ViewHolder extends RecyclerView.ViewHolder
        ...
        public ViewHolder(View view, ItemClickListener itemClickListener) {
            ...
            mlocation= (TextView) view.findViewById(R.id.locationdescription);
            LikeButton= (Button)view.findViewById(R.id.buttonofLike);
            mComments=(TextView)view.findViewById(R.id.commentnumber);
