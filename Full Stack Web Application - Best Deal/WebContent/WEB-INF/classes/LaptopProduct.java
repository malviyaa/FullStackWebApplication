...
public class LaptopProduct extends HttpServlet {
	...
	String type;
	HashMap<String, Console> laptopidHash;
	Console laptopdetailsHash;
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		laptopidHash = ProductStore.getLaptopProducts(request.getSession().getServletContext().getRealPath("laptop.xml"), "laptop");

		for (String key : laptopidHash.keySet()) {
			laptopdetailsHash = laptopidHash.get(key);
			name = laptopdetailsHash.getName();

			image = laptopdetailsHash.getImage();
			// System.out.println(image);
			price = laptopdetailsHash.getPrice();
			retailer = laptopdetailsHash.getRetailer();
			condition = laptopdetailsHash.getCondition();
			RetailerCity = laptopdetailsHash.getRetailerCity();
			RetailerZip = laptopdetailsHash.getRetailerZip();
			RetailerState = laptopdetailsHash.getRetailerState();
			ProductOnSale = laptopdetailsHash.getProductOnSale();
			ManufacturerName = laptopdetailsHash.getManufacturerName();
			ManufacturerRebate = laptopdetailsHash.getManufacturerRebate();
