	...
	<body>
			...
			<div >
				...
				<div class="width">
						...
						<h5>Your Booking Id is ETC12345678.</h5>
						<h5>An Email has been sent to you with the Booking Id, your Itinerary, Vehicle and Extras along with the receipt for the booking.</h5>
						<h5>You can view and modify your booking from the Reservations tab using the Booking Id.</h5>
